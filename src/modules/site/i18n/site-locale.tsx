...
const english = {
  ...
  work: {
    ...
    yearsLabel: "Years",
    placesLabel: "Places",
    startLabel: "Start with photograph 01",
  ...
  about: {
    eyebrow: "05 / About",
    title: "I write software and take photographs.",
    paragraphOne:
      "I’m YueYong. I work in software and take photographs in daily life and while travelling.",
    paragraphTwo:
      "Work holds edited selections. Places keeps broader sets organized by country and city. Journeys pairs photographs with notes from the road.",
    nameLabel: "Name",
    roleLabel: "Work",
    roleValue: "Software engineer / Photographer",
    portraitCaption: "University of Sydney / Australia",
...
const chinese = {
  ...
  about: {
    eyebrow: "05 / 关于",
    title: "平时写代码，出门时拍照。",
    paragraphOne: "我叫 YueYong，平时做软件开发。这里放的是我在日常和旅行中拍下的照片。",
    paragraphTwo:
      "“作品”里是挑过的照片。“足迹”按国家和城市整理，数量会多一些。“旅程”留下路上的照片和笔记。",
    nameLabel: "名字",
    roleLabel: "平时做什么",
    roleValue: "写代码 / 拍照",
    portraitCaption: "澳大利亚 / 悉尼大学",
    practice: "这个网站",
    workNote: "挑出来的照片",
    placesNote: "按地点整理的照片",
